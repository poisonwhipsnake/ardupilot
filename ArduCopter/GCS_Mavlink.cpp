...
void GCS_MAVLINK_Copter::send_pid_tuning()
{
    ...
    for (uint8_t i=0; i<ARRAY_SIZE(axes); i++) {
        ...
        case PID_TUNING_ROLL:
            ...
            pid_info = &copter.attitude_control->get_angle_yaw_p().get_pid_info();
        ...
        case PID_TUNING_ACCZ:
            pid_info = &copter.attitude_control->get_angle_pitch_p().get_pid_info();
...
void GCS_MAVLINK_Copter::handle_wheel_distance(const mavlink_message_t &msg)
{
    ...
    wheelEncoder.updateMavlinkWheelEncoders(packet.distance,sender_sysid);
