...
public:
    ...
    Vector2f turn_distance( const struct Location &prev_wp,const struct Location &current_loc,const struct Location &turn_WP, const struct Location &next_WP, float _trimspeed) ;//const;
...
private:
    ...
    AP_Float _L1_Turning_Period;
    AP_Float _L1_Exit_Percent;
    ...
    AP_Float _turn_radius;
    AP_Float _turn_radius_compensation;
    AP_Float _turn_start_offset;
