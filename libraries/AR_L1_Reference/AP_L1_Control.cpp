...
const AP_Param::GroupInfo AP_L1_Control::var_info[] = {
    ...
    AP_GROUPINFO("GRE_EX_T", 23, AP_L1_Control, _ground_risk_exclusion_timeout, 5.0f),
...
void AP_L1_Control::setup_loiter_to_new_track(Vector2f newTrack, Location LoiterPoint2) {
    orbit_allowed = 0;
...
void AP_L1_Control::ground_risk_exclusion_event_trigger(void)
{
...
void AP_L1_Control::update_waypoint_straight(const struct Location &prev_WP, const struct Location &next_WP, float dist_min)
{
