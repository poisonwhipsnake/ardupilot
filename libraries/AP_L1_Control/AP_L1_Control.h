...
public:
    ...
    Location get_loiter_location(void) const override {return desired_loiter_point;}
    ...
    float get_reintercept_tollerance (void) const override {return _max_auto_point_distance ;}
    ...
    void update_waypoint_strait(const struct Location &prev_WP, const struct Location &next_WP, float dist_min) override;
    ...
    void setup_loiter_to_new_track(Vector2f newTrack) override;
...
private:
    ...
    AP_Float _turn_around_reintercept_tollerance;
    ...
    float _loiter_exit_track;
    bool _use_loiter_for_turn = true;
    bool _turn_around_gre_exception;
    ...
    int8_t _current_nav_type;

    Location desired_loiter_point;
